...
class PlaceApiProvider {
  ...
  static final String androidKey = googleKey;
  ...
  Future<List<Suggestion>> fetchSuggestions(String input, String lang) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (result['status'] == 'OK') {
        ...
        print(result);
        return result['predictions'].map<Suggestion>((p) => Suggestion(p['place_id'], p['description'], p['structured_formatting']['secondary_text'])).toList();
      }
