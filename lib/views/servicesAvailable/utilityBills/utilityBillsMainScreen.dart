...
class UtilityBillsMain extends StatefulWidget {
  @override
  _UtilityBillsMainState createState() => _UtilityBillsMainState();
}

class _UtilityBillsMainState extends State<UtilityBillsMain> {
  @override
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                CircleAvatar(
                  backgroundImage: AssetImage(ConstanceData.utilityBillService),
                  radius: 70,
                ),
                SizedBox(height: 10),
                ...
                SizedBox(height: 60),
                CustomText(
                    text: 'Armotale Utilities will be launching in your area soon. We\'ve got you covered...',
