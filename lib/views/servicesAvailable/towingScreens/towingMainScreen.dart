...
class TowingMain extends StatefulWidget {
  @override
  _TowingMainState createState() => _TowingMainState();
}

class _TowingMainState extends State<TowingMain> {
  @override
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                CircleAvatar(
                  backgroundImage: AssetImage(ConstanceData.towTruckService),
                  radius: 70,
                ),
                SizedBox(height: 10),
                ...
                SizedBox(height: 60),
                CustomText(
                    text: 'Armotale towing services will be launching in your area soon. We\'ve got you covered...',
