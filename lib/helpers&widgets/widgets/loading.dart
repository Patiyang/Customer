...
class Loading extends StatelessWidget {
  ...
  const Loading({Key key, this.text, this.color, this.height, this.size, this.spinkitColor, this.textColor, this.fontWeight}) : super(key: key);
  @override
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            text != null
                ? CustomText(text: text ?? '', letterSpacing: .3, fontWeight:fontWeight?? FontWeight.w500, size: 15, color: textColor ?? Colors.black)
                : SizedBox.shrink()
          ],
        ),
      ),
